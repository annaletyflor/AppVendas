...
namespace AppVendasWeb.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,ProdutoDescricao,PrecoProduto,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProdutoId,ProdutoDescricao,PrecoProduto,CategoriaId")] Produto produto)
        {
